        ...
        for ( int m =0 ;m<mapWidth;m++)
                {
                    ...
                    {       //그 
                        ...
                        if (newarray[m,n]==0 || newarray[m, n] == 7)
                        {
                        ...
                        else if (newarray[m, n] == 8 || newarray[m, n] == 9 || newarray[m, n] == 10 || newarray[m, n] ==11 || newarray[m, n] == 12 || newarray[m, n] == 13 || newarray[m, n] == 14 || newarray[m, n] == 15 )
                         {
